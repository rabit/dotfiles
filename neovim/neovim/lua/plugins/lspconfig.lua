...
local on_attach = function(client, bufnr)
    ...
    if client.resolved_capabilities.document_highlight then
        vim.api.nvim_exec([[
        hi LspReferenceRead cterm=bold ctermbg=DarkMagenta gui=reverse
        hi LspReferenceText cterm=bold ctermbg=DarkMagenta gui=reverse
        hi LspReferenceWrite cterm=bold ctermbg=DarkMagenta gui=reverse
